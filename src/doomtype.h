...
#endif
#if defined (__unix__) || defined (__APPLE__) || defined (UNIXCOMMON) || defined(__WUT__) || defined(__wii__)
	#undef stricmp
...
#if defined (_WIN32) || defined (__HAIKU__) || defined(__WUT__) || defined (__wii__)
...
#if (defined(__WUT__) || defined(__wii__))
